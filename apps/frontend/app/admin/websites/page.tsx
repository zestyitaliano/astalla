...
export default async function AdminWebsitesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="card-surface rounded-3xl border bg-card/90 p-6 shadow-card">
        <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="max-w-2xl space-y-3">
            ...
            <h1 className="text-2xl font-semibold text-text">Marketing sites connected to your data</h1>
          ...
          <div className="rounded-2xl border border-dashed border-border/70 bg-muted/40 p-5 text-sm text-muted-foreground">
            <p className="font-medium text-text">Ready for production</p>
            <p className="mt-1">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {featureCards.map(({ title, description, icon: Icon }) => (
          <div key={title} className="rounded-3xl border border-border bg-card/90 p-5 shadow-card">
            <div className="flex items-center gap-3">
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-primary/40 bg-primary/10 text-primary">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.1fr,1fr]">
        <div className="rounded-3xl border border-border bg-card/90 p-6 shadow-card">
          <h2 className="text-lg font-semibold text-text">Go live without engineering backlogs</h2>
        ...
        <div className="rounded-3xl border border-border bg-card/90 p-6 shadow-card">
          <h2 className="text-lg font-semibold text-text">How the workflow stays on track</h2>
