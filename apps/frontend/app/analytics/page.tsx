    ...
    <div className="space-y-6">
      <div className="card-surface rounded-2xl border bg-card/90 p-6 shadow-card">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button className="inline-flex items-center gap-2 rounded-lg border border-border bg-card/80 px-3 py-2 text-sm font-medium text-text shadow-sm transition hover:shadow-cardHover">
              <SlidersHorizontal className="h-4 w-4" />
              Filters
            </button>
            <button className="inline-flex items-center gap-2 rounded-lg border border-border bg-card/60 px-3 py-2 text-sm text-muted-foreground transition hover:text-text">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {chartPlaceholders.map((chart) => (
          <div
            key={chart.id}
            className="card-surface flex flex-col rounded-2xl border bg-card/90 p-5 shadow-card transition hover:shadow-cardHover"
          >
            <div className="mb-4">
              <h2 className="text-base font-semibold text-text">{chart.title}</h2>
              <p className="text-sm text-muted-foreground">{chart.description}</p>
            </div>
            <div className="flex flex-1 items-center justify-center rounded-xl border border-dashed border-border/70 bg-muted/40 p-6 text-sm text-muted-foreground">
